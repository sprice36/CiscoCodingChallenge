...
import { getPrevDate } from "./utility";
import companyLogo from "./img/cisco.png";
...
class App extends React.Component {
	...
	onSubmit = () => {
		...
		let apiKey = 'LANFOLV1ZTQT1416';
		let stockURL = apiUrl + `function=${functionType}&symbol=${symbol}&apikey=${apiKey};`;
		let date = getPrevDate();
		console.log(date)
		console.log(stockURL);
      ...
      //  console.log(this.prop.stockPriceData)
	...
	render() {
		...
		return (
			<div className="parentDiv">
				<img src={companyLogo} alt="cisco logo" />
